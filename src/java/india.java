...
public class india extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            user.visit("http://ahmedabadmirror.indiatimes.com/getsearchdata.cms?query=india");
...
//            request.setAttribute("el", element);
            ...
            user.visit("http://indianexpress.com/?s=india");
            ...
            RequestDispatcher rd=request.getRequestDispatcher("breaking.jsp");
