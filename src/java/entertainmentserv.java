 ...
 * @author User
 */
public class entertainmentserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            user.visit("http://ahmedabadmirror.indiatimes.com/getsearchdata.cms?query=entertainment");
...
//            request.setAttribute("el", element);
            ...
            user.visit("http://indianexpress.com/?s=entertainment");
