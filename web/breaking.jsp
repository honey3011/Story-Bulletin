	...
	<div id="templatemo_main_leftcol" style="width: 1000px;">
            <div class="templatemo_rcol_sectionwithborder" style="width: 1000px;">
               <%
                ...
                %>
                <div id="templatemo_blog_section" class="boxed" style="width: 1000px;">
<!--                    <h2 align="center"><b><u>India News</u></b></h2><br>-->
                    ...
                    <div class="blog_box">
                        ...
                        <hr/>
                        <h5><a href="openlink?url1=<%=e1.getIndurl().get(i)%>"><%=e1.getTheindianexpress().getElement(i).innerHTML() %></a></h5>
                        <hr/>
                     </div>
