<%-- 
    Document   : search
    Created on : 22 Mar, 2017, 6:31:25 PM
    Author     : User
--%>

<%-- 
    Document   : entertainment
    Created on : 8 Feb, 2017, 3:51:53 AM
    Author     : asmita shah
--%>
...
<!--                                <h2 align="center"><b><u>News</u></b></h2><br>-->
                                <% for(int i=0;i<10;i++){%>
                                <div class="blog_box">
                                    <h4><a href="openlink?url=<%=e1.getAhmurl().get(i)%>"><%=e1.getAhmedabadmirror().getElement(i).innerHTML() %></a></h4>
                                    <hr/>
                                    <h4><a href="openlink?url1=<%=e1.getIndurl().get(i)%>"><%=e1.getTheindianexpress().getElement(i).innerHTML() %></a></h4>
                                    <hr/>
                                </div>
